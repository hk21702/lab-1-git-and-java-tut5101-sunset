...
public class IntroLabTest {
     ...
     */
    @Test(timeout = 1000)
    public void testchouch12(){
        String expected = "Hello! My name is Benson! " +
                "I like cats more than dogs! Cats are just better what can I say.";
        String actual = IntroLab.chouch12();
        assertEquals(expected, actual);
    }
}
